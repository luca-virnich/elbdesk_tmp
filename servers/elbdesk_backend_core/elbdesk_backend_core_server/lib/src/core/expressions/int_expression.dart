...
Expression<dynamic>? intExpression(ColumnInt column, FilterField filterField) {
  final v = int.tryParse(filterField.value);
  if (v == null) {
    return null;
  }
  switch (filterField.type) {
    ...
    // TODO(all): Some of these could be implemented for an int expression
