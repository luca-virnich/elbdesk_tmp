...
abstract class ArtworkCodeDTO
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      if (description != null) 'description': description,
      'artworkCodeType': artworkCodeType,
      if (code2of5 != null) 'code2of5': code2of5?.toJsonForProtocol(),
      if (codeAztec != null) 'codeAztec': codeAztec?.toJsonForProtocol(),
      if (codeTemplate != null)
        'codeTemplate': codeTemplate?.toJsonForProtocol(),
    };
  }
