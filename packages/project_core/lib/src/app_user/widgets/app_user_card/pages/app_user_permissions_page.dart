...
///
class _AppUserPermissionsPage extends HookConsumerWidget {
  /// @nodoc
  const _AppUserPermissionsPage({
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final initialState = useMemoized(
      () => ref.read(appUserStateProvider(appUserId, sessionId)).requireValue,
      [appUserId, sessionId],
    );
              ...
              child: NextDropdownMenu<AppScopePermission>(
                ...
                onSelected: (scopePermission) {
                  if (scopePermission != null) {
                    ref
                        .read(
                          appUserStateProvider(appUserId, sessionId).notifier,
                        )
