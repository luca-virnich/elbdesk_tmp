...
class _$EntityAssignmentImpl extends _EntityAssignment {
  ...
  @override
  String toString() {
    return 'EntityAssignment(entityId: $entityId, additionalData: $additionalData, tableType: $tableType, deadline: $deadline)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, entityId, additionalData, tableType, deadline);
