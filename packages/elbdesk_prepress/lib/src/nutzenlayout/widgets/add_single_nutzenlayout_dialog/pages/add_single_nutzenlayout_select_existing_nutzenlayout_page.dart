...
class _AddSingleNutzenlayoutSelectExistingNutzenlayoutPage
    extends HookConsumerWidget {
  const _AddSingleNutzenlayoutSelectExistingNutzenlayoutPage({
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final nutzenlayouts = ref.watch(
      fetchNutzenlayoutsByCustomerWithDimensionsProvider(
        ...
        width: firstArtwork.width,
        height: firstArtwork.height,
      ),
    );
...
class _NutzenLayoutTile extends HookConsumerWidget {
  ...
  final Set<Artwork> selectedArtworks;
  final int salesOrderId;
  final GlobalKey<NavigatorState> navigatorKey;
  final String sessionId;
      ...
      onTap: () async {
        await AsyncHandler.handleAsyncOperation(
          ...
          () async {
            await ref
                .read(
                  nutzenlayoutRepositoryProvider,
                )
                .addArtworktsToNutzenlayout(
                  layout: nutzenlayout,
                  salesOrderId: salesOrderId,
                            ...
                            child: Column(
                              ...
                              children: [
                                LabeledValueRow(
                                  title: 'Maße'.hc,
                                  value: nutzenlayout
                                      .formattedSingleDimension(locale),
