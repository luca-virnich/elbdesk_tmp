...
import 'package:elbdesk_lints/src/utils.dart';
...
class ConvertPositionalToNamedFormal extends DartAssist {
  ...
  void run(
    ...
    context.registry.addFormalParameterList((node) {
      // parameter list has positional optional parameters, named params
      // cannot be added
      ...
      reporter
        ...
        final namedParam = '${Keyword.REQUIRED.lexeme} '
            '${Keyword.THIS.lexeme}.${parameter.name},';
