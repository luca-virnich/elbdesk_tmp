...
// selected child.
const EdgeInsets _kThumbInsets =
    EdgeInsets.symmetric(horizontal: -2, vertical: -2);

// Minimum height of the segmented control.
// const double _kMinSegmentedControlHeight = 28;
          ...
          child: DecoratedBox(
            decoration: BoxDecoration(
              color: Colors.red.withOpacity(
                Colors.red.opacity * separatorOpacityController.value,
              ),
...
class AppSlidingControl<T extends Object> extends StatefulWidget {
  AppSlidingControl({
  ...
  @override
  State<AppSlidingControl<T>> createState() => _SegmentedControlState<T>();
}

class _SegmentedControlState<T extends Object>
    extends State<AppSlidingControl<T>>
    with TickerProviderStateMixin<AppSlidingControl<T>> {
  ...
  @override
  void didUpdateWidget(AppSlidingControl<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
  ...
  @override
  Widget build(BuildContext context) {
    final borderRadius = context.appTheme.buttonStyles.primary.borderRadius;
...
class _SegmentedControlRenderWidget<T extends Object>
  ...
  RenderObject createRenderObject(BuildContext context) {
    return _RenderSegmentedControl<T>(
      ...
      state: state,
      cornerRadius: context.appTheme.buttonStyles.primary.borderRadius,
    );
  }
...
class _RenderSegmentedControl<T extends Object> extends RenderBox
  ...
  double computeMinIntrinsicHeight(double width) {
    var child = firstChild;
    var maxMinChildHeight = UiConstants.buttonHeight - 6;
    while (child != null) {
  ...
  double computeMaxIntrinsicHeight(double width) {
    var child = firstChild;
    var maxMaxChildHeight = UiConstants.buttonHeight - 6;
    while (child != null) {
  ...
  double _getMaxChildHeight(BoxConstraints constraints, double childWidth) {
    var maxHeight = UiConstants.buttonHeight - 6;
    var child = firstChild;
    while (child != null) {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (highlightedChildIndex != null) {
      ...
      _paintThumb(context, offset, thumbRect, 4);
    } else {
