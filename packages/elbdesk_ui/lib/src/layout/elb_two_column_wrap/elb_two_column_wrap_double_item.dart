...
class ElbTwoColumnWrapDoubleItem<L> extends ElbTwoColumnWrapItemBase<L> {
  ...
  Widget buildWidget({
    ...
    return NextCardFormField.double(
      label: effectiveLabel,
      showLabel: showLabel,
      labelPosition: labelPosition,
      initialDouble:
          showInitialEmptyOrNullValueAs0 && value == null ? 0 : value,
      onClear: onClear,
      controller: controller,
      onChanged: onChanged != null && !effectiveReadOnly
          ? (v) {
              if (returnEmptyAs0 && v.isEmpty) {
                onChanged?.call(0);
              } else {
                final asDouble = Parser.parseDouble(v);
                onChanged?.call(asDouble);
              }
            }
          : null,
