// ignore_for_file: avoid_setters_without_getters, prefer_asserts_with_message
...
/// forever.
///
/// [enabled] controls if shimmer effect is active. When set to false the
/// animation
/// is paused
///
///
...
///
/// * use one [AppShimmer] to wrap list of [Widget]s instead of a list of
/// many [AppShimmer]s
///
@immutable
class AppShimmer extends StatefulWidget {
  ...
  /// [AppShimmer] which [gradient] is [LinearGradient] made up of `baseColor`
  ///  and
  /// `highlightColor`.
  ///
  ///
