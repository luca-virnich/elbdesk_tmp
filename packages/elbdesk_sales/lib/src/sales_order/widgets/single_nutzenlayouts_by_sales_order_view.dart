...
class SingleNutzenlayoutsBySalesOrderView extends ConsumerWidget {
  const SingleNutzenlayoutsBySalesOrderView({
    ...
    return Column(
      children: [
        CollapsibleCardSection(
          leadingIcon: AppIcons.soiEinzelformaufbau,
          identifier: ComponentIdentifier
              .salesOrderCardItemsPageSingleNutzenlayouts.name,
          title: salesL10n.soi_einzelformaufbau_plural,
          trailingWidgets: [
...
class _NutzenlayoutTile extends HookConsumerWidget {
  ...
  final SalesOrderSingleNutzenlayoutLight salesOrderNutzenlayout;
  final int customerId;
  final int salesOrderId;
  final String sessionId;
  final String floatingWindowId;
                        ...
                        child: Column(
                          ...
                          children: [
                            LabeledValueRow(
                              title: 'Maße'.hc,
                              value:
                                  nutzenlayout.formattedSingleDimension(locale),
                              width: infoRowWidth,
                            ),
                            LabeledValueRow(
                              title: 'Drucklänge'.hc,
