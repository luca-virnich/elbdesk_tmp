...
@immutable
class FloatingSoiRequestArtworkApprovalWindowData extends FloatingWindowData {
  FloatingSoiRequestArtworkApprovalWindowData({
    ...
    this.initialNoteParentId,
          ...
          windowType: FloatingWindowType.soiRequestArtworkApproval.name,
          icon: FloatingWindowType.soiRequestArtworkApproval.icon,
