...
String _$floatingWindowTitleStateHash() =>
    r'9b52bd5f11223ca302a5c127cd49710dc1bb3345';
...
abstract class _$FloatingWindowTitleState
  ...
  FloatingWindowTitlebarData build(
...
class FloatingWindowTitleStateFamily
  ...
  ///
  /// Copied from [FloatingWindowTitleState].
  FloatingWindowTitleStateProvider call(
    String floatingWindowId,
  ) {
    return FloatingWindowTitleStateProvider(
      floatingWindowId,
    );
  }
...
///
/// Copied from [FloatingWindowTitleState].
class FloatingWindowTitleStateProvider extends AutoDisposeNotifierProviderImpl<
    FloatingWindowTitleState, FloatingWindowTitlebarData> {
  /// FloatingWindowTitleState
  ///
  /// Holds the title for a floating window
  ///
  ...
  ///
  /// Copied from [FloatingWindowTitleState].
  FloatingWindowTitleStateProvider(
    String floatingWindowId,
  ) : this._internal(
  ...
  @override
  AutoDisposeNotifierProviderElement<FloatingWindowTitleState,
      FloatingWindowTitlebarData> createElement() {
...
class _FloatingWindowTitleStateProviderElement
    extends AutoDisposeNotifierProviderElement<FloatingWindowTitleState,
        FloatingWindowTitlebarData> with FloatingWindowTitleStateRef {
